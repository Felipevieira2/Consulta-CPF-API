...
<div class="py-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Cabeçalho -->
        <div class="mb-10">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Detalhes do Plano</h1>
            <p class="text-gray-600 dark:text-gray-400">Informações detalhadas sobre seu plano atual</p>
        </div>
